...
{
    public class NPC : Entity, ISelectHandler, IDeselectHandler
    {
        static public NPC SelectedNPC { get; private set; }
        static private NPC firstSelect;
        ...
        ************************************************************/
        ...
        public Entity GetVotedTarget()
        {
            return trait.GetVotedTarget(this, GameSystem.GameData.Instance.Entities);
        }
    }
}